...
plot(electric_dt$Date, electric_dt$Global_active_power, type="l",
     xlab="", ylab="Global Active Power")

plot(electric_dt$Date, electric_dt$Voltage, type="l",
...
plot(electric_dt$Date, electric_dt$Global_reactive_power, type="l",
